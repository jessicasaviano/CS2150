...
private:
  ...
  void insert(BinaryNode*& node1, const string& x);

  string pathTo(BinaryNode* node1, const string& x) const;

  bool find(BinaryNode* node1, const string& x) const;
  
  int numNodes(BinaryNode* node1) const;
};
