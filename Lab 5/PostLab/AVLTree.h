...
private:
  ...
  void insert(AVLNode*& node1, const string& x);
  string pathTo(AVLNode* node1, const string& x) const;
  bool find(AVLNode* node1, const string& x) const;
  int numNodes(AVLNode* node1) const;
