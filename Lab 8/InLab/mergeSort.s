...
mergeSort:
	...
	cmp rsi, rdx 		
	jge end
	mov r10, rdx 		; store rdx value to local var r10
	add r10, rsi 		;second is rsi, third is rdx
	shr r10, 1
	...
	mov rdx, r10			;divide 2, this is to get rdx to be 
	call mergeSort
	...
	sub r10,1
	mov rcx, rdx			;sub oen to r11 to get mid again
	mov rdx, r10		;store r11 into third paramter rdc	

				;store r10 (whic has end from rdx) into rcx
	call merge		;merge(A, rdi (start), rsi(middle), rdx(end))
...
merge:
	...
	sub r14, rsi			;subtracting regiser = register - something
	inc r14
